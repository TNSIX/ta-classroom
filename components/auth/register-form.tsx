    ...
    return (
        <Card className="w-full max-w-md shadow-lg rounded-2xl border-gray-100 dark:border-zinc-800/60 bg-white dark:bg-zinc-950">
            ...
            <CardContent className="space-y-6">
                <div>
                    <Button variant="outline" className="w-full h-11 bg-white hover:bg-gray-50 text-gray-700 border-gray-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:text-zinc-300 dark:border-zinc-800 transition-colors shadow-sm">
                        <svg
                        ...
                        เข้าสู่ระบบด้วยด้วย Google Account
                    </Button>
                </div>
                ...
                <form className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input id="firstName" className="h-11 shadow-sm focus-visible:ring-blue-600 bg-gray-50/50 dark:bg-zinc-900/50" placeholder="ชื่อ" required />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="lastName" className="text-zinc-900 font-medium dark:text-zinc-100">นามสกุล</Label>
                            <Input id="lastName" className="h-11 shadow-sm focus-visible:ring-blue-600 bg-gray-50/50 dark:bg-zinc-900/50" placeholder="นามสกุล" required />
                        </div>
                    </div>

                    <div className="space-y-2">
                        <Label htmlFor="email" className="text-zinc-900 font-medium dark:text-zinc-100">อีเมล</Label>
                        <Input id="email" type="email" className="h-11 shadow-sm focus-visible:ring-blue-600 bg-gray-50/50 dark:bg-zinc-900/50" placeholder="กรอกอีเมล" required />
                    </div>
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="confirmPassword" className="text-zinc-900 font-medium dark:text-zinc-100">ยืนยันรหัสผ่านอีกครั้ง</Label>
                        <div className="relative">
                            <Input
                                id="confirmPassword"
                    ...
                    <div className="pt-2">
                        <Button type="submit" className="w-full h-11 text-base shadow-md bg-blue-600 text-white hover:bg-blue-700 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200 transition-all rounded-lg">
                            สร้างบัญชีผู้ใช้งาน
                        </Button>
                    </div>
                </form>
